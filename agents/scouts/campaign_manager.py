...
YOUR TASK:
Produce a concrete, actionable **Campaign Playbook** for today.

Read the reports above. Extract the highest-value opportunities where NitroStack can:
a) Reply to an existing thread with a genuinely helpful, non-spammy answer (REPLY)
b) Create a new post that fills a visible content gap the community is asking about (NEW POST)
...
[2–3 sentences: dominant themes across all platform reports today]
